...
const RecentUpdates = ({ updates }) => {
  ...
  return (
    <div className={`p-6 ${isDarkMode ? 'bg-greenblack-light' : 'bg-softcoral'}`}>
      ...
      <div className={`flex-1 m-4 md:m-10 pt-16 md:pt-0`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-10">
          <div className="lg:col-span-3 space-y-6 md:space-y-10">
            <div className={`${isDarkMode ? 'bg-greenblack-light' : 'bg-softcoral'} p-4 md:p-6 rounded-lg shadow-md`}>
          ...
          <div className={`lg:col-span-1 ${isDarkMode ? 'bg-greenblack-light' : 'bg-softcoral'} rounded-lg shadow-lg`}>
